...
try {
    ...
    app.use("/", require("./routers/faq"))
    app.use("/", require("./routers/muscular"))
    app.use("/", require("./routers/choice"))
    app.use("/", require("./routers/organs"))
    app.use("/", require("./routers/blood"))
    app.use("/", require("./routers/index_organs"))
    app.use("/", require("./routers/index_circulary"))
    app.use("/", require("./routers/index_skeleton"))
    app.use("/", require("./routers/skeleton"))
    ...
    app.use("/", require("./routers/accessed/blood"))
